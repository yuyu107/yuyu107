...
我是一名喜欢折腾系统与游戏的 B站 UP 主。分享 Minecraft 版本更新、实用教程和旧系统兼容实测，也会把排查过程中用到的方法做成工具，在这里整理源码与文档。
...
| 内容方向 | 视频中聊些什么 |
| --- | --- |
| 🖥️ 旧系统与软件兼容 | Windows 7 / 8.1 运行 Minecraft、旧版 Steam 下载与启动问题，以及旧版 macOS 运行 Steam 的实测。 |
| ⛏️ Minecraft 更新与特性 | Java 快照、预发布版与基岩版更新，新功能、特性修复，以及 Beta / Preview 相关介绍。 |
| 🧰 资源与存档教程 | 基岩版资源文件夹与解包、安卓存档导出，以及启动报错的处理方法。 |
| 💿 系统安装与实验 | Windows 安装升级、系统镜像与重装工具实测，也尝试在 Windows XP 上运行 Steam 和游戏。 |
